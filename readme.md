...
```bash
git clone https://github.com/ionic-team/stencil-component-starter.git lazy-loading-img
cd lazy-loading-img
...
- Put a script tag similar to this `<script src='https://unpkg.com/lazy-loading-img@0.0.1/dist/lazyloadingimg.js'></script>` in the head of your index.html
